...
## Phase 17: UI Refactor (Geist Light Aesthetic)

Goal: Implement the "Geist Light" (Clear) aesthetic: Pure white backgrounds, subtle gray borders, and black typography.

- [/] **Global CSS Refactor (`static/css/style.css`)**
  - [/] Set Root Variables (White bg, Black text, Gray borders).
  - [/] Update Sidebar (Light Gray bg, Right border).
  - [/] Update Button Styles (Primary = Black/White, Secondary = White/Gray).
  - [/] Iconography (Lucide).
- [ ] **Component Polish**
  - [ ] **Status Dots**: Bright Green / Deep Red.
  - [ ] **Server Cards**: White bg, subtle borders.
  - [ ] **Inventory & Tables**: Clean, borderless rows.
